...
class UserRepositoryImpl implements UserRepository {
  ...
  @override
  Future<DataState<Pair<VerificationStatus, String>>>
      getVerificationStatus() async {
    try {
      final httpResponse = await userRemoteDataSource.getVerificationStatus();
  ...
  @override
  Future<DataState<void>> sendReport(ReportEntity report) async {
    try {
      final httpResponse = await userRemoteDataSource.sendReport(report);
  ...
  Future<DataState<bool>> checkFollowUser(String userId) async {
    try {
      final httpResponse = await userRemoteDataSource.checkFollowUser(userId);
